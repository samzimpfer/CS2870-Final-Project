...
The code chunk below reads in our data about UFO sightings. We had to convert the datetime variable to year, month, date format. Then we created a new dataframe containing only necessary variables for our purposes. 
...
**year**: year when sighing occured
**month**: month when sighitng occured 
