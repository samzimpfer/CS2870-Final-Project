...
=======
  ...
  In order to work with our data we had to clean it. This includeded converting the datetime column into year, month, day, seconds, minutes, hours format. Then we created a new data set where we added columns for years, seconds, and months and kept the updated datetime, city, state, country, longitude, and latitude columns. We then had to convert both latitude and seconds into numeric values and only keep values that would not return an NA value in order to work with them. The code for this data cleaning follows: 
>>>>>>> 4a642e38c0b9c8cf5a6548b0616cc2d478353148
